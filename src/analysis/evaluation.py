...
def compute_metrics(masks_dir: Path) -> pd.DataFrame:
    ...
    Params:
        masks_dir: Path, path to the directory containing 'reference' and algorithm subdirectories
    Returns: 
    ...
    for alg in algorithms:
        ...
        # Sort to ensure alignment with reference masks for comparison.
...
def plot_confusion_matrix(cm: np.ndarray, title: str) -> None:
    ...
    """
    # Check that confusion matrix array is 2x2 and not empty.
    if cm.shape != (2, 2):
